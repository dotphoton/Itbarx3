...
import com.itbarxproject.enums.ReplyProcessesLinks;
import com.itbarxproject.json.ReplyModelParserJSON;
import com.itbarxproject.listener.ReplyProcessesServiceListener;
import com.itbarxproject.model.reply.ReplyAddModel;
import com.itbarxproject.model.reply.ReplyDeleteModel;
...
public class ReplySL extends BasePostServiceSL<String> {

	private static final String NAME_OF_THE_CLASS = ReplySL.class.getSimpleName();
	ReplyProcessesServiceListener<String> replyProcessesServiceListener;

	public ReplySL(Context appContext, ReplyProcessesServiceListener<String> listener, int serviceResUriId) {
