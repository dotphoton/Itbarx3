...
public enum GlobalDataForWS {
	...
	REPLY_ID("ReplyId"), POST_SPEECH_TO_TEXT("PostSpeechToText"), POST_TEXT("PostText"),POST_REPLY_BYTE("PostReplyByte"),POST_ADDED_TIME_ZONE_ID("PostAddedTimeZoneId"),EMAIL_CODE("EmailCode"),
	LOGIN_CATEGORY("LoginCategory "),ID_INFO("IdInfo");
