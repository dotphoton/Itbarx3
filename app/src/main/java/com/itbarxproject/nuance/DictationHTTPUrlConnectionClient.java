...
import com.itbarxproject.common.MySSLSocketFactory;
...
public class DictationHTTPUrlConnectionClient {

	String language = "tr_TR";

	public DictationHTTPUrlConnectionClient(String language_code, String AudioFile)
	{
		language = language_code; audioFile=AudioFile;
	}
	/*
	 **********************************************************************************************************
	 ...
	 *********************************************************************************************************
	 */
	private String APP_ID = "HTTP_NMDPPRODUCTION_itbarx_llc_ITBARX_UMUT_20151007063106";
	private String APP_KEY = "1235faf61846cf97f1ce68207b2b0f06047078a821ebef8e44ac3fb826841b38b9152ed25bfe694cccd26c48fd7b4e02ebc6aa0cb2999bf646daae6c5ec9a518";
	private String DEVICE_ID = "100001";
	private String LANGUAGE_TR = "tr_TR";
	...
	private String audioFile3 = Environment.getExternalStorageDirectory()+
	"/com.itbarx/male_speex_8.wav";
	private String audioFile = Environment.getExternalStorageDirectory()+
			"/com.itbarx/user5_224525_0.wav";
	/*
	...
	public HttpClient getHttpClient() throws NoSuchAlgorithmException, KeyManagementException
	{
		...
		try {
			KeyStore trustStorex = KeyStore.getInstance(KeyStore.getDefaultType());
			trustStorex.load(null, null);

			MySSLSocketFactory mySsl = new MySSLSocketFactory(trustStorex);

			mySsl.setHostnameVerifier(SSLSocketFactory.ALLOW_ALL_HOSTNAME_VERIFIER);
			//sf = new SSLSocketFactory(trustStorex);
			Scheme sch = new Scheme("https", mySsl, PORT);	// PORT = 443
	 ...
	 */
	public HttpPost getHeader(URI uri, long contentLength) throws UnsupportedEncodingException
	{
	...
	public InputStreamEntity setAudioContent() throws NumberFormatException, Exception
	{
		File f = new File(audioFile);
		if( !f.exists() )
		{
			Log.d("ITbarx", String.valueOf("Audio file does not exist: " + audioFile));
			return null;
		}
		if( !isStreamed )
		{
...
HttpEntity httpEntity = MultipartEntityBuilder.create()
	...
	public List<String> processResponse(HttpResponse response) throws IllegalStateException, IOException
	{
		...
		Log.d("ITbarx",String.valueOf(response.getStatusLine()));
		if (resEntity != null) {
			Log.d("ITbarx", String.valueOf("Response content length: " + resEntity.getContentLength()));
			Log.d("ITbarx", String.valueOf("Chunked?: " + resEntity.isChunked()));
			Log.d("ITbarx", String.valueOf("Nuance Session Id: " + response.getFirstHeader("x-nuance-sessionid").getValue()));
			...
			try {
				...
				while((sentence = reader.readLine()) != null){
					...
					responseDataList.add(sentence);
					Log.d("ITbarx", "sentence #" + index++ + " : " + sentence);
				}
...
*/
	...
	private boolean checkArgs(String[] args) {
		...
		if (args.length > 20)  {
			Log.d("ITbarx","Error: too many arguments.");
			printUsage();
			return false;
		}
		...
		for( int i = 0; i < args.length; i=i+2)
		{
			...
			{
				Log.d("ITbarx","Error: invalid flag " + args[i]);
				printUsage();
				return false;
			}
		}
	...
	public static void printUsage(){
		 ...
		 * -r sample_rate 
		 */
		Log.d("ITbarx","Usage: java -jar DictationHTTPClient.jar \n" +
				"Optional inputs:\n" +
				"\t-a app id\n" +
	...
	{
		Log.d("ITbarx", "----------------- Application Settings ----------------------");
		Log.d("ITbarx", "App Id: " + this.APP_ID);
		Log.d("ITbarx", "App Key: " + this.APP_KEY);
		Log.d("ITbarx", "Device Id: " + this.DEVICE_ID);
		Log.d("ITbarx", "Language: " + this.LANGUAGE);
		Log.d("ITbarx", "Language Model: " + this.LM);
		Log.d("ITbarx","Audio Format: " + this.CODEC);
		Log.d("ITbarx", "Language Model: " + this.LM);
		Log.d("ITbarx", "Sample Rate: " + this.sampleRate);
		Log.d("ITbarx", "Audio File: " + this.audioFile);
		Log.d("ITbarx", "Is Streamed: " + Boolean.toString(this.isStreamed));
		Log.d("ITbarx", "Results Format: " + this.RESULTS_FORMAT);
		Log.d("ITbarx", "Host: " + DictationHTTPUrlConnectionClient.HOSTNAME);
		Log.d("ITbarx", "Port: " + DictationHTTPUrlConnectionClient.PORT);
		Log.d("ITbarx", "Servlet: " + DictationHTTPUrlConnectionClient.SERVLET);
