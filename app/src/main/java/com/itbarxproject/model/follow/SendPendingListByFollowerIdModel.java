...
public class SendPendingListByFollowerIdModel {
	...
	public SendPendingListByFollowerIdModel() {
	super();
	}

	public SendPendingListByFollowerIdModel(String rowNum, String followerID_FK, String followingID_FK, String followRelationStatusE, String followingDate, String followingPendingStatus,
		String userID, String name, String itBarxUserName, String locationID_FK, String signUpDate, String profileUpdateDate, String userBio, String genderEnumCode, String userFollowStatus,
		String userEmail, String userPassword, String userAccountStatus, String userProfilePhoto, String lastWallSeenDate, String favouriteUserCount, String notificationCount, String userRole,
		String mentionName, String userWebsite, String userPassEmailCode, String userPasswordChangedDate) {
	super();
	this.rowNum = rowNum;
