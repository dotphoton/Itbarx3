...
private LoginButton btnfaceLoginButton;
	...
	//	ButterKnife.bind(this);
		...
		btnSignInButton = (SignInButton)findViewById(R.id.login_activity_screen_googlePlus_signIn_button);
		btnFacebook = (ButtonBold) findViewById(R.id.login_activity_screen_facebook_button);
		btnfaceLoginButton = (LoginButton) findViewById(R.id.login_activity_screen_facebook_signIn_button);
		...
		mGoogleApiClient = new GoogleApiClient.Builder(this).addConnectionCallbacks(connectionCallbacks).
				addOnConnectionFailedListener(failedListener).addApi(Plus.API, Plus.PlusOptions.builder().build()).addScope(Plus.SCOPE_PLUS_LOGIN).build();
